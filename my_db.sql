...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=605976003ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=my_db&table=users">`my_db`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_2&table=tb_2">`db_2`.`tb_2`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=cart">`shop_db`.`cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=users">`shop_db`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=products">`shop_db`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db&table=tb_student">`db`.`tb_student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db&table=admins">`db`.`admins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_school&table=tb_student">`db_school`.`tb_student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecom_store&table=admins">`ecom_store`.`admins`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5976563e4e4831617b47574560647068">
